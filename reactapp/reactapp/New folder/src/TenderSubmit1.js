        ...
        const addTender = (obj) => {
         ...
         const addUserInfo = ()=>{
            var obj2 = {
                ...
                tenderLocation:FormData.tenderLocation,
                postDate:FormData.postDate,
                endDate:FormData.tenderDeadline,
                tenderAmount:parseInt(FormData?.tenderAmount)
            }
 ...
 {/* onSubmit={handleSubmit}  //under the form field */}
        ...
        <table>
            ...
            <tbody>
                ...
                <td>
                Business Name:
                    <input type="text" maxLength={50} name="businessName" value={BusFormData.businessName} onChange={handleInputChangeBusiness}/> </td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        Tender Business Location: <input type="Text" name="tenderLocation" maxLength="10" value={FormData.tenderLocation} onChange={handleInputChange}/>
                    </td>
                </tr>
                <tr>
                    <td>
